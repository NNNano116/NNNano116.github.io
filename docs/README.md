...
| [main1-scroll-interactions.md](./main1-scroll-interactions.md) | **main-1 스크롤 인터랙션 시스템** ✅ (2026-06-24) — 3페이지 1-라우트·다크↔라이트 색 반전(`--inv` 3/5 트리거)·명칭 모프+섹션 타이틀 핸드오프·11개 다국어+단어별 rise·임계 스프링 스냅·라이트 글라스·반응형 |
